module libraries::time_lock {
    ...
    const SRC_WITHDRAWAL: u64 = 0;
    const SRC_PUBLIC_WITHDRAWAL: u64 = 1;
    const SRC_CANCELLATION: u64 = 2;
    const SRC_PUBLIC_CANCELLATION: u64 = 3;
    ...
    public fun get(timelock: &Timelocks, stage: u64): u64{
